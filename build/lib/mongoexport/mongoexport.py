...
class MongoExport():
    ...
    def __init__(self,host:str,username:str,password:str, port:int=27017):
        if username and password:
            mongo_uri = f'mongodb://{username}:{password}@{host}:{port}/?authMechanism=DEFAULT'
...
if __name__ == '__main__':
    m = MongoExport("3.104.14.8","root",'1RFdM3NXkKN5Q552')
    df = m.create_csv("integro","Syncs",{"name":"Testing"})